...
Share "Viewer" access with mosque.screens786@gmail.com.
...
| KEY | VALUE |
| --- | ----- |
| REACT_APP_PRAYER_DATA_SPREADSHEET_URL | https://api.mosque.tech/prayer-times/{google_sheets_id} |
| REACT_APP_APP_CONFIG_SPREADSHEET_URL  | https://api.mosque.tech/prayer-screen-config/{google_sheets_id} |
| REACT_APP_HADITH_DATA_SPREADSHEET_URL | https://api.mosque.tech/hadith-data/{google_sheets_id} |
...
point-rpi
@chromium-browser --noerrdialogs --disable-session-crashed-bubble --disable-infobars --start-fullscreen --start-maximized --app=https://elm.mosque.tech
```
5. `sudo reboot`
